namespace DCSLibraryRepository
{
    partial class LoginForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            test = new MaterialSkin.Controls.MaterialButton();
            ...
            // test
            // 
            test.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            test.Density = MaterialSkin.Controls.MaterialButton.MaterialButtonDensity.Default;
            test.Depth = 0;
            test.HighEmphasis = true;
            test.Icon = null;
            test.Location = new Point(412, 466);
            test.Margin = new Padding(4, 6, 4, 6);
            test.MouseState = MaterialSkin.MouseState.HOVER;
            test.Name = "test";
            test.NoAccentTextColor = Color.Empty;
            test.Size = new Size(158, 36);
            test.TabIndex = 16;
            test.Text = "materialButton1";
            test.Type = MaterialSkin.Controls.MaterialButton.MaterialButtonType.Contained;
            test.UseAccentColor = false;
            test.UseVisualStyleBackColor = true;
            test.Click += materialButton1_Click;
            // 
            // LoginForm
            // 
        ...
        private MaterialSkin.Controls.MaterialButton test;
    }
}
